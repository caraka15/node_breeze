...
$totalBounty = ($totaltweets * 4) + ($totalReddit * 10) + ($totalNews * 25) + ($totalYoutube * 3) + $totalRep;

$finalReps = $userRep + ($twitterBounty * 4) + ($youtubeBounty * 3) + ($redditBounty * 10) + ($newsBounty * 25);
