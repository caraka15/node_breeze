<div
    class="mx-auto max-w-full space-y-8 overflow-hidden border-t px-4 pb-4 pt-12 dark:border-gray-700 dark:bg-gray-800 sm:px-6 lg:px-8">
    <nav class="-mx-5 -my-2 flex flex-wrap justify-center dark:bg-gray-800">
        <div class="px-5 py-2">
